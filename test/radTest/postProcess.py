...
absorptivity = 1e-1 # m-1
alpha = 1e-15
print("F " , F)
print("Trad" , (c/4/sigma)**(1/4))
...
radiationCase_1em8 = np.loadtxt('postProcessing/sampleDict/0.001/Centerline_G_T.xy')
radiationCase_1em6 = np.loadtxt('postProcessing/sampleDict/0.001/Centerline_G_T.xy')
...
plt.plot(x[:-3], u_1, 'x' , label='u Analytical @ tau = 1')
# plt.plot(x[:-10], u_0001, 'x' , label='u Analytical @ tau = 0.001')
# plt.plot(x[:-3]/np.sqrt(3) / absorptivity, u_100, 'x' , label='u Analytical tau = 100')
plt.plot(xNum_1em8 ,  G_1em8/c ,  label='u Numerical @ tau = 1')
plt.plot(xNum_1em6  ,  G_1em6/c , label='u Numerical @ tau = 100')
...
plt.plot(x[:-4], (v_1 / sigma * F)**0.25  , 'x' , label='u Analytical @ tau = 1')
plt.plot(xNum_1em8  ,  T_1em8  , label='u Numerical @ tau = 1')
