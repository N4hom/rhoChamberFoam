...
if scale == 'lin':
    #pressure = np.linspace(np.exp(9.1), np.exp(11.52), num=4)
    pressure = np.array([100000 , 100100 , 100200 , 100300])
    print("Delta pressure ",pressure[1:] - pressure[:-1])
    temperature = np.linspace(np.exp(5), np.exp(6), num=4)
    temperature = np.array([150, 200 , 250 , 300])
